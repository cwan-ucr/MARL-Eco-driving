...
class SAC_agent():
    ...
    def save(self, ep_i, CAV_PR, time_step, control_strategy, RL_agent):
        ...
        output_path_actor = output_dir + "actor_{}_timestep_{}_{}_{}.pth".format(time_step, ep_i, control_strategy, RL_agent)
        output_path_critic = output_dir + "critic_{}_timestep_{}_{}_{}.pth".format(time_step, ep_i, control_strategy, RL_agent)
    ...
    def load(self, epoch, CAV_PR, time_step, control_strategy, RL_agent):
        ...
        input_path_actor = input_dir + "actor_{}_timestep_{}_{}_{}.pth".format(time_step, epoch, control_strategy, RL_agent)
        input_path_critic = input_dir + "critic_{}_timestep_{}_{}_{}.pth".format(time_step, epoch, control_strategy, RL_agent)
